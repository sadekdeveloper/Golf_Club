...
$(function(){		
    ...
    jQuery(".skin-1").on('click',function(){
		...
		jQuery(".home-style-3 .header-bnr img, .site-footer .footer-top img").attr("src", "images/favicon.png");
        return false;
    });
    ...
    jQuery(".skin-2").on('click',function(){
		...
		jQuery(".home-style-3 .header-bnr img, .site-footer .footer-top img").attr("src", "images/favicon2.png");
        return false;
    });
    ...
    jQuery(".skin-3").on('click',function(){
		...
		jQuery(".home-style-3 .header-bnr img, .site-footer .footer-top img").attr("src", "images/favicon3.png");
        return false;
    });
    ...
    jQuery(".skin-4").on('click',function(){
		...
		jQuery(".home-style-3 .header-bnr img, .site-footer .footer-top img").attr("src", "images/favicon4.png");
        return false;
    });
    ...
    jQuery(".skin-5").on('click',function(){
		...
		jQuery(".home-style-3 .header-bnr img, .site-footer .footer-top img").attr("src", "images/favicon5.png");
        return false;
    });	
    ...
    jQuery(".skin-6").on('click',function(){
		...
		jQuery(".home-style-3 .header-bnr img, .site-footer .footer-top img").attr("src", "images/favicon6.png");
        return false;
    });		
    ...
    jQuery(".skin-7").on('click',function(){
		...
		jQuery(".home-style-3 .header-bnr img, .site-footer .footer-top img").attr("src", "images/favicon7.png");
        return false;
    });
    ...
    jQuery(".skin-8").on('click',function(){
		...
		jQuery(".home-style-3 .header-bnr img, .site-footer .footer-top img").attr("src", "images/favicon8.png");
        return false;
    });	
	//=== Color css change function	=====================//	
