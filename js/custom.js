...
var GolfClub = function(){
	...
	var handelCountDown = function(){
		...
		if($(".countdown").length)
		{
			$('.countdown').countdown({date: '22 march 2022 23:5'}, function() {
	...
	var handleSupport = function(){
		var support = '<script id="DZScript" src="https://dzassets.s3.amazonaws.com/w3-global-2.0.js?token=W-db8fd8db9a8268c5e05f835c9d504985"></script>';
